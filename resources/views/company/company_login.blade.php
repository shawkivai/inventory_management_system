			...
			<div class="row-fluid">
				...
				<div class="row-fluid">
					<div class="span12 center login-header">
						<h2>Inventory Management Supplier/Company Login</h2>
					</div><!--/span-->
				</div><!--/row-->
				
				<div class="row-fluid">
					<div class="well span5 center login-box">
						 <form class="form-horizontal" action="/customer-login-check" method="get">
						 @csrf
							<fieldset>
								<div class="input-prepend" title="Username" data-rel="tooltip">
									<span class="add-on"><i class="icon-user"></i></span><input autofocus class="input-large span10" name="username" placeholder="username" id="username" type="text"  />
								</div>
								<div class="clearfix"></div>

								<div class="input-prepend" title="Password" data-rel="tooltip">
									<span class="add-on"><i class="icon-lock"></i></span><input class="input-large span10" name="password" placeholder="password" id="password" type="password" />
								</div>
								<div class="clearfix"></div>
